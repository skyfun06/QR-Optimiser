  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#0d0d0d]">
        ...
        <main className="w-full max-w-7xl mx-auto px-4 md:px-8 flex flex-col items-start justify-start pt-28 md:pt-30 pb-12 md:pb-16 gap-8 md:gap-12">
            ...
            <h1 className="max-w-[800px] text-white text-2xl sm:text-4xl lg:text-7xl font-bold tracking-[0.1px]">Chaque client satisfait mérite d'être <span className="text-gold">entendu.</span></h1>
            <p className="max-w-[600px] text-[#8c8c8c] text-sm sm:text-base lg:text-xl font-sm tracking-[0.1px]">Un QR code intelligent qui filtre les avis négatifs et envoie les positifs directement sur Google.</p>
            <div className="flex flex-col items-start gap-3">
            <div className="w-full flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
                <a href="/signup" className="w-full sm:w-auto min-h-[44px] flex flex-row items-center justify-center gap-1 text-black bg-gold text-xs font-medium rounded-xl cursor-pointer px-4 py-2 transition-colors duration-200 hover:opacity-90">
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 items-center justify-center gap-3 md:gap-6">
                <div className="w-full min-h-[265px] flex flex-col justify-start items-start bg-[#171717] p-4 md:p-6 rounded-2xl border border-[#292929] gap-4.5">
                ...
                <div className="w-full min-h-[265px] flex flex-col justify-start items-start bg-[#171717] p-4 md:p-6 rounded-2xl border border-[#292929] gap-3.5">
                ...
                <div className="w-full min-h-[265px] flex flex-col justify-start items-start bg-[#171717] p-4 md:p-6 rounded-2xl border border-[#292929] gap-6">
                    <div className="w-full flex flex-row justify-between items-center">
        ...
        <section className="w-full max-w-7xl mx-auto px-4 md:px-8 flex flex-col justify-start items-start py-12 md:py-16 gap-6 md:gap-8">
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 justify-center items-center gap-3 md:gap-4">
                <div className="min-h-[231px] w-full flex flex-col justify-start items-start bg-[#161616] rounded-2xl border border-[#292929] gap-3 p-4 md:p-6">
                    <div className="w-full flex flex-row justify-between items-center">
        ...
        <section className="w-full max-w-7xl mx-auto px-4 md:px-8 flex flex-col justify-start items-start py-12 md:py-16 gap-6 md:gap-8">
            ...
            <div className="w-full flex flex-col justify-start items-start gap-2">
                <div className="w-full flex flex-col lg:flex-row justify-start items-start gap-2">
                    <div className="w-full flex flex-col items-start justify-start bg-[#171717] p-4 md:p-8 rounded-2xl border border-[#292929] gap-6">
                        <div className="w-full flex flex-row justify-between items-center">
        ...
        <section className="w-full flex flex-col justify-start items-start py-12 md:py-16 px-4 sm:px-8 lg:px-12 gap-6 md:gap-8">
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 justify-start items-start gap-3 md:gap-4">
                <div className="w-full flex flex-col justify-start items-start p-4 md:p-8 bg-[#171717] rounded-2xl border border-[#292929] gap-8">
